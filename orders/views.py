...
from .models import Category, MenuItem, MenuItemAddon, Order, Payment
...
class PlaceOrderView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            redirect_view = 'order_payment' if \
                order.payment_method == 'CardOnline' else 'track_order'
...
def order_payment(request, pk):
    ...
    #redirect to track_order if payment succeeds or back to this view if it fails
